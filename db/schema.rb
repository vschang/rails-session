...
ActiveRecord::Schema.define(version: 2022_09_28_112701) do
  ...
  create_table "repost_likes", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "repost_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["repost_id"], name: "index_repost_likes_on_repost_id"
    t.index ["user_id"], name: "index_repost_likes_on_user_id"
  end
  ...
  add_foreign_key "repost_likes", "reposts"
  add_foreign_key "repost_likes", "users"
